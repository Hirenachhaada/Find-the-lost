...
import com.dataflair.foundandlost.Adpaters.NotificationAdapter;
...
public class NotificationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Assigning the Recyclerview to show all the Notifications
        ...
        FirebaseRecyclerOptions<Model> options =
                new FirebaseRecyclerOptions.Builder<Model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("notifications").child(userId), Model.class)
                        .build();
